...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="manage-products.php"><i class="menu-icon icon-table"></i>Manage Products </a></li>
																<li><a href="insert-author.php"><i class="menu-icon icon-paste"></i>Insert Author </a></li>
																<li><a href="manage-author.php"><i class="menu-icon icon-paste"></i>Manage Author </a></li>
                            </ul><!--/.widget-nav-->
