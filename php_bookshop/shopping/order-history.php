...
<?php $query=mysqli_query($con,"select books.bookimg1 as pimg1,books.name as pname,books.id as proid,orders.productId as opid,orders.quantity as qty,books.price as pprice,books.shippingCharge as shippingcharge,orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid from orders join books on orders.productId=books.id where orders.userId='".$_SESSION['id']."' and orders.paymentMethod is not null");
$cnt=1;
