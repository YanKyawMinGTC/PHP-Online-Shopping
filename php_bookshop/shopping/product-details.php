...
<?php
$ret=mysqli_query($con,"select category.categoryName as catname,subCategory.subcategory as subcatname,books.name as pname from books join category on category.id=books.category join subcategory on subcategory.id=books.subCategory where books.id='$pid'");
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">Top book</h3>
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
		
								   <?php
$ret=mysqli_query($con,"select * from books order by rand() limit 4 ");
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['name']);?>/<?php echo htmlentities($rws['bookimg1']);?>"  width="200" height="334" alt="">
							</div>
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['name']);?>" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['bookimg1']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['bookimg1']);?>" width="370" height="350" />
                </a>
            </div>
            ...
            <div id="owl-single-product-thumbnails">
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                        <img class="img-responsive"  alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['bookimg1']);?>" />
                    </a>
                </div>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php echo htmlentities($row['bookAvailability']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
								...
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											...
											<span class="value"><?php echo htmlentities($row['author_name']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											...
											<span class="price-strike">Rs.<?php echo htmlentities($row['bookPriceBeforeDiscount']);?></span>
										</div>
									</div>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"><?php echo $row['bookDescription'];?></p>
									</div>	
								</div><!-- /.tab-pane -->
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=mysqli_query($con,"select * from books where subCategory='$subcid' and category='$cid'");
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['bookimg1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
			...
			<div class="product-price">	
				<span class="price">
					Rs.<?php echo htmlentities($rw['price']);?>			</span>
										     ...
										     <?php echo htmlentities($rw['bookPriceBeforeDiscount']);?></span>
